    ...
    <div className="flex h-full w-full flex-col items-center justify-center gap-[50px]">
      <div className="flex flex-col items-center justify-center text-[18px] text-[#80809A]">
        ...
        <p className="mt-4 text-center">
          <span className="gradient-bg rounded-lg px-4 py-2 font-bold text-white shadow-2xl">
            PAW BUDDY
          </span>{' '}
          를 이용하기 위해서는
        </p>
      ...
      <Link
        href="/login"
        className="flex h-[54px] w-full max-w-105 min-w-40 flex-row items-center justify-center rounded-[14px] bg-[#FF6000] p-[17px] text-[14px] font-bold text-white"
      >
        로그인 하기
      </Link>
    </div>
