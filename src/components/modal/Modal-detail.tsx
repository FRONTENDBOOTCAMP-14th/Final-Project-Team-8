...
export function ModalDetailInput({ isModify }: ModalDetailInputProps) {
  return (
    <div>
      <form>
        {/* ✅ 주요 정보 섹션 */}
        ...
        <dl className="gap flex items-center">
          ...
          <div className="mt-3 mr-4 mb-3 ml-4 flex min-w-[50px] flex-col">
            ...
            <input
              type="text"
              // defaultValue="A583D01"
              placeholder="Lot 정보를 입력해주세요"
              className="w-full rounded-md border-2 border-amber-400 p-1 placeholder:text-sm focus:border-orange-500 focus:outline-none"
            />
          </div>
