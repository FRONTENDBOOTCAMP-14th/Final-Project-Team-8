type ModalTypeVaccinationProps = {
  isModify: boolean
}
...
export function ModalTypeVaccinationTable() {
  return (
    <div>
      {/* ✅ 주요 정보 섹션 */}
      ...
      <ul className="flex items-start gap-4">
        ...
        <li className="mt-3 flex flex-1 basis-0">
          ...
          <div className="flex flex-col justify-center">
            <h3 className="text-base text-gray-700">Lot</h3>
            <div className="text-base font-bold text-gray-800">A583D01</div>
          </div>
        </li>
        ...
        <li className="mt-3 flex flex-1 grow basis-0">
          ...
          <div className="flex flex-col justify-center">
            <div className="text-base text-gray-700">접종 날짜</div>
        ...
        <li className="mt-3 flex flex-1 grow basis-0">
          ...
          <div className="flex flex-col justify-center">
            <div className="text-base text-gray-700">유효 기간</div>
      ...
      <ul className="flex items-start gap-4">
        ...
        <li className="flex grow">
          ...
          <div className="mt-3 flex w-full flex-col">
            <div className="text-base text-gray-700">Lot(제조번호)</div>
            <div className="mt-1">
