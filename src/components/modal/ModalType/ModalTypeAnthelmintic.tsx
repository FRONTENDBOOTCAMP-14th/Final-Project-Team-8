...
export default function ModalTypeAntheelmintic({
  isModify,
}: ModalTypeOtherTreatmentProps) {
  return (
    <>
      {!isModify ? (
        <ModalTypeAntheelminticTable />
      ) : (
        <ModalTypeAntheelminticInput />
      )}
    </>
  )
}

export function ModalTypeAntheelminticTable() {
  return (
    <div>
      {/* ✅ 주요 정보 섹션 */}
      ...
      <ul className="flex items-start gap-4">
        ...
        <li className="mt-3 flex flex-1 basis-0">
          ...
          <div className="flex flex-col justify-center">
            <h3 className="text-base text-gray-700">복용 날짜</h3>
            <time
              dateTime="2018-4-29"
...
// Input 컴포넌트
export function ModalTypeAntheelminticInput() {
  return (
    <div>
      {/* ✅ 주요 정보 섹션 */}
      <h2 className="text-[18px] font-bold text-gray-800">상세</h2>
