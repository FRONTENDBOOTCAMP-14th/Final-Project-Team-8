...
export default function PetDetailEditSection({
  ...
  return (
    <section className="relative mt-5 flex h-full flex-col overflow-y-auto">
      ...
      <form
        ...
        className="flex h-full flex-col items-center gap-5 px-2"
      >
        {/* Form Container */}
        ...
        {/* 버튼 그룹 */}
        <div className="absolute bottom-3 box-border flex w-full gap-3 p-0.5">
